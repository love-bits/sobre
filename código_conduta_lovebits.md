# Regras de conduta para participantes do Love Bits

Essas são as regras de conduta para que não aconteça nenhum transtorno por parte dos(as) envolvidos(as) em nossos projetos.

O Love Bits é um local aberto a todos e todos devem se sentir confortáveis participando de nossas iniciativas.
...
Código de conduta baseado em: [https://github.com/training-center/sobre/blob/master/CONDUCT.md](https://github.com/training-center/sobre/blob/master/CONDUCT.md)